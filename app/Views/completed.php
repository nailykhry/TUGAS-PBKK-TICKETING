...
<html lang="en">
    ...
    <body>
        ...
        <!-- Image -->
        <img src="Images/vacation.png" class="rounded mx-auto d-block" alt="Responsive image" width="250" height="250">
        ...
        <div class="card m-5 w-50 mx-auto shadow" style="border: none">
            ...
            <div class="row mt-3 mb-3">
                <div class="col text-center">
                    <img src="Images/qantas.png" width="100" height="100">
                    <p class="card-text">Qantas Airlines</p>
                    <p class="card-text">
                        <!-- From -->
                        Jakarta (CGK)
        ...
        <div class="d-grid gap-2 col-6 mx-auto mb-5" >
            <button class="btn btn-primary" type="button" style="background-color: #239BD8; color: white; border: none;">
                Print Ticket
            </button>
        </div>
